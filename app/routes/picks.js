...
exports.pickRoutes = [
    {
        ...
        config: {
            ...
            handler: function (request, reply) { return __awaiter(_this, void 0, void 0, function () {
                var credentials, userChoices, dbUserPicks, _i, userChoices_1, userChoice, pick, success;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            credentials = request.auth.credentials;
                            userChoices = request.payload;
                            if (!(userChoices && userChoices.length)) return [3 /*break*/, 2];
                            dbUserPicks = [];
                            for (_i = 0, userChoices_1 = userChoices; _i < userChoices_1.length; _i++) {
                                userChoice = userChoices_1[_i];
                                pick = {
                            ...
                            return [4 /*yield*/, predictions_1.saveUserPicks(dbUserPicks)];
                        case 1:
                            success = _a.sent();
                            _a.label = 2;
                        case 2:
